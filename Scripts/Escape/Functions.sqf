drn_fnc_Escape_OnSpawnGeneralSoldierUnit = {
	[_this] call Zagor_fnc_onEnemySoldierSpawn;
};
...
drn_fnc_Escape_MedicalSitePositions = {
...
drn_fnc_Escape_AddRemoveComCenArmor = {
    ...
    _comCenArmorItem = Zagor_arr_Escape_ComCenArmors select _comCenArmorIndex;
    ...
    if (count _armorObjects == 0) then {
        ...
        
        {
            ...
            _result = [_spawnPos, 0, _x, Zagor_VAR_Side_Opfor] call BIS_fnc_spawnVehicle;
            _vehicle = _result select 0;
			[_vehicle] call Zagor_fnc_onVehicleSpawn;
...
drn_fnc_Escape_InitializeComCenArmor = {
...

    {
        ...
        switch (_enemyFrequency) do
        {
            case 1:
            {
                Zagor_arr_Escape_ComCenArmors set [count Zagor_arr_Escape_ComCenArmors, [_pos, [selectRandom Zagor_arr_ComCenDefence_lightArmorClasses], []]];
            };
            case 2:
            {
                Zagor_arr_Escape_ComCenArmors set [count Zagor_arr_Escape_ComCenArmors, [_pos, [selectRandom Zagor_arr_ComCenDefence_heavyArmorClasses], []]];
            };
            default
            {
                Zagor_arr_Escape_ComCenArmors set [count Zagor_arr_Escape_ComCenArmors, [_pos, [selectRandom Zagor_arr_ComCenDefence_lightArmorClasses, selectRandom Zagor_arr_ComCenDefence_heavyArmorClasses], []]];
            };
        };
...
if (isServer) then {
    Zagor_var_Escape_FunctionsInitializedOnServer = true;
    publicVariable "Zagor_var_Escape_FunctionsInitializedOnServer";
};
