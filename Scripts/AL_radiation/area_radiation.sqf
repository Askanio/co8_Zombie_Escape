...
//{sleep 0.1; [[[_x,_ras_radius,_damage_rad,_rad_prot_maska,_rad_detector], "Scripts\AL_radiation\rad_emitter.sqf"], "BIS_fnc_execVM", true, true] spawn BIS_fnc_MP;} foreach lista_finala_radiatie;
{sleep 0.1;[[_x,_ras_radius,_damage_rad,_rad_prot_maska,_rad_detector], "Scripts\AL_radiation\rad_emitter.sqf"] remoteExec ["execVM",0,true]} foreach lista_finala_radiatie;

if (glowindark) then 
{
	{[_x,_ras_radius] execvm "Scripts\AL_radiation\ai_glowing.sqf"} foreach lista_finala_radiatie;
};
