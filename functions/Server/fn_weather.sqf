//Clouds
private _weatherParamOvercast = if (Zagor_Param_WeatherOvercast isEqualTo -1) then {
...
//Fog
private _weatherParamFog = if (Zagor_Param_WeatherFog isEqualTo -1) then {
...
//Wind
private _weatherParamWind = if (Zagor_Param_WeatherWind isEqualTo -1) then {
...
//Rain
private _weatherParamRain = if (Zagor_Param_WeatherRain isEqualTo -1) then {
